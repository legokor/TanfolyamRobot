...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef* huart)
{
    ...
    char c = txt_handleReceiveCplt(&main_robotInstance.espUart, ESP_UART,
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
    ...
    switch (GPIO_Pin)
    {
        case ENC1_A_Pin: enc_handlerA(&main_robotInstance.rightEncoder); break;
        case ENC2_A_Pin: enc_handlerA(&main_robotInstance.leftEncoder); break;
    }
}

 ...
 *
 * A form of output data for the module is the PWM output, which has a square
 * wave period of 20 Hz. The high level corresponds to the measured distance
 * Formula: Distance (mm) = High time (ms) * 100 = High time (us)/10
 * For example, if the measured high time is 10000us, then
 * Distance=10000/10=1000mm
 *

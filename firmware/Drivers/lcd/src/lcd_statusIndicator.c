...
static const uint8_t lcd_batteryChar[][8] = {
    {0b01110, 0b10101, 0b11011, 0b01110, 0b01110, 0b10001, 0b01110,
     0b10001},  // battery dead
    {0b01110, 0b11011, 0b10001, 0b10001, 0b10001, 0b10001, 0b10001,
     0b11111},  // battery level 0
    {0b01110, 0b11011, 0b10001, 0b10001, 0b10001, 0b10001, 0b11111,
     0b11111},  // battery level 1
    {0b01110, 0b11011, 0b10001, 0b10001, 0b10001, 0b11111, 0b11111,
     0b11111},  // battery level 2
    {0b01110, 0b11011, 0b10001, 0b10001, 0b11111, 0b11111, 0b11111,
     0b11111},  // battery level 3
    {0b01110, 0b11011, 0b10001, 0b11111, 0b11111, 0b11111, 0b11111,
     0b11111},  // battery level 4
    {0b01110, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111,
     0b11111},  // battery level 5
};
 ...
 */
static const uint16_t lcd_voltageThreshold[] = {
    BATTERY_CELL_COUNT * 3290,  // 5%
...
void lcd_displayStatus(uint8_t row,
  ...
  for (uint8_t i = 0; i < lcd_levelNum; i++) {
    // At this point we know that the voltage is higher than the highest
    // threshold
    if (i == lcd_levelNum - 1) {
      c = i;
      break;
